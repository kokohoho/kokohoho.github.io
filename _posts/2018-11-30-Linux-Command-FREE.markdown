...
![avatar](/img/linux/buff&cache.png)
...
![avatar](/img/linux/free-t.png)

#### 周期性的查询内存使用信息

**free -s 10**

![avatar](/img/linux/free-s.png)
